...
train_loader = data.DataLoader(ds_train,batch_size=16, shuffle=True, num_workers=4)
...
if __name__ == '__main__':
    model = ColorizeClassifier(feature_cascade=(512, 256, 64, 64))
    model.freeze_ft()
    model.cuda()
    ...
    train(model, optimizer, criterion, epochs, None)
    save_files_to_wandb() 
